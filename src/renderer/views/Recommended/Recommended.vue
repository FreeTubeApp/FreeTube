<template>
  <div>
    <ft-card class="card">
      <h2>{{ $t("Recommended.Recommended") }}</h2>
      <ft-flex-box
        class="subscriptionTabs"
        role="tablist"
        :aria-label="$t('Recommended.Recommended Tabs')"
      >
        ...
        <div
          ...
          aria-controls="recommendedPanel"
...
<script src="./Recommended.js" />
<style scoped src="./Recommended.css" />
