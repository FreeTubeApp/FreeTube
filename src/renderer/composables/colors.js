...
export function useColorTranslations() {
  ...
  return computed(() => [
    ...
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Rosewater'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Flamingo'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Pink'),
    ...
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Maroon'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Peach'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Yellow'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Green'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Teal'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Sky'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Sapphire'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Blue'),
    t('Settings.Theme Settings.Main Color Theme.Catppuccin Latte Lavender'),
