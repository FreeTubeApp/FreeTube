...
export default defineComponent({
  ...
  methods: {
    ...
    transformAndInsertCaptions: async function () {
      const captionList = await transformCaptions(this.captionHybridList, this.currentLocale)
      if (this.captionHybridList[0] instanceof Promise) this.$emit('store-caption-list', captionList)
