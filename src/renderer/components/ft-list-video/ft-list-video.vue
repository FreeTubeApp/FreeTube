<template>
  ...
  >
    ...
    >
      ...
      <div
        v-if="isLive || isUpcoming || isMemberOnly || (displayDuration !== '' && displayDuration !== '0:00')"
        class="videoDuration"
        :class="{
          live: isLive,
          upcoming: isUpcoming,
      ...
      >
        {{ isLive ? $t("Video.Live") : (isUpcoming ? $t("Video.Upcoming") : (isMemberOnly ? $t("Video.Member Only") : displayDuration)) }}
      </div>
      <ft-icon-button
