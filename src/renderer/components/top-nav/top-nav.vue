<template>
  ...
  >
    <div class="side">
      ...
      <ft-icon-button
        class="navIconButton"
        :disabled="arrowBackwardDisabled"
        :class="{ arrowDisabled: arrowBackwardDisabled }"
        :icon="['fas', 'arrow-left']"
        :theme="null"
        :size="20"
        :use-shadow="false"
        dropdown-position-x="right"
        :dropdown-options="sessionNavigationHistoryDropdownOptions"
      ...
      <ft-icon-button
        ...
        :class="{ arrowDisabled: arrowForwardDisabled }"
