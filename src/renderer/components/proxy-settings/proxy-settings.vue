  ...
  >
    ...
    >
      ...
      >
        ...
        <p>
          {{ $t('Settings.Proxy Settings.Ip', { ip: proxyIp}) }}
        </p>
        <p>
          {{ $t('Settings.Proxy Settings.Country', { country: proxyCountry }) }}
        </p>
        <p>
          {{ $t('Settings.Proxy Settings.Region', { region: proxyRegion}) }}
        </p>
        <p>
          {{ $t('Settings.Proxy Settings.City', { city: proxyCity}) }}
        </p>
      </div>
    </template>
  </ft-settings-section>
