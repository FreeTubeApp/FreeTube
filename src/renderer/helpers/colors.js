...
export const colors = [
  ...
  { name: 'CatppuccinLatteRosewater', value: '#dc8a78' },
  { name: 'CatppuccinLatteFlamingo', value: '#dd7878' },
  { name: 'CatppuccinLattePink', value: '#ea76cb' },
  { name: 'CatppuccinLatteMauve', value: '#8839ef' },
  { name: 'CatppuccinLatteRed', value: '#d20f39' },
  { name: 'CatppuccinLatteMaroon', value: '#e64553' },
  { name: 'CatppuccinLattePeach', value: '#fe640b' },
  { name: 'CatppuccinLatteYellow', value: '#df8e1d' },
  { name: 'CatppuccinLatteGreen', value: '#40a02b' },
  { name: 'CatppuccinLatteTeal', value: '#179299' },
  { name: 'CatppuccinLatteSky', value: '#04a5e5' },
  { name: 'CatppuccinLatteSapphire', value: '#209fb5' },
  { name: 'CatppuccinLatteBlue', value: '#1e66f5' },
  { name: 'CatppuccinLatteLavender', value: '#7287fd' },
