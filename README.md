...
Both LibRedirect and RedirectTube can automatically redirect YouTube links to FreeTube.
RedirectTube also offers two manual ways, and LibRedirect also works for other services. 
