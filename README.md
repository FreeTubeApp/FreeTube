...
* Flatpak on Flathub: [Download](https://flathub.org/apps/details/io.freetubeapp.FreeTube) or [Source](https://github.com/flathub/io.freetubeapp.FreeTube)
...
* PortableApps (Windows Only): [Download](https://github.com/rddim/FreeTubePortable/releases) or [Source](https://github.com/rddim/FreeTubePortable)
